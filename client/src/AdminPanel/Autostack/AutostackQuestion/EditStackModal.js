...
const EditStackModal = ({ modal, setModal,questionId,gameId,setModalId,questionName}) => {
    ...
    const addController = () => {
        const apiUrl=`/api/admin/bets/edit_autostack/${questionId}`
    ...
    useEffect(() => {
       setAccountDetails({questionName:questionName})
    }, [questionName])
    return (
        <div >
