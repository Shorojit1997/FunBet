...
import { adminoginActionHandeler } from '../../Store/Actions/Admin/AdminLoginAction'
...
const AdminLogin = () => {
    ...
    const submitHandeler = (e) => {
         ...
         dispatch(adminoginActionHandeler(loginInfo,history))
    }
    ...
    return (
        <div className='deposit_main' style={{background:'none'}}>
            <div className='admin_deposit_div'>
                ...
                <div className='admin_deposit_header'>Admin</div>
