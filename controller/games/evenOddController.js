...
const WheelRate = require('../../models/EvenOddRate')
...
const evenOddRatingSetGetController = async (req, res, next) => {
    try {
        ...
        return res.status(200).json({
            ...
            evenOddInfo: wheelInfo ? wheelInfo : wheelrate 
        })
...
const evenOddRatingSetPostController = async (req, res, next) => {
...
const evenOddAdminPicPostController = async (req, res, next) => {
