...
const cardRatingSetGetController = async (req, res, next) => {
    try {
        ...
        return res.status(200).json({
            flashMessage: '',
            cardInfo: coinInfo ? coinInfo : coinrate 
        })
...
const cardRatingSetPostController = async (req, res, next) => {
...
const cardAdminPicPostController = async (req, res, next) => {
